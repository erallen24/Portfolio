            ...
            <div className="relative h-64 md:h-80 overflow-hidden bg-muted">
                ...
                <div className="absolute inset-x-0 top-1/2 -translate-y-1/2 flex justify-between px-4 opacity-0 group-hover:opacity-100 transition-opacity">
                    <motion.button
                        ...
                        whileTap={{ scale: 0.9 }}
                        onClick={prev}
                        className="p-2 bg-white/20 backdrop-blur-sm rounded-full text-white hover:bg-white/30 transition-colors z-10"
                    >
                ...
                <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="absolute top-4 right-4 px-4 py-2 bg-white/20 backdrop-blur-sm rounded-lg text-white flex items-center gap-2 hover:bg-white/30 transition-colors cursor-pointer z-10"
                >
